...
<body class="skin-blue">
    <button class="btn-print" style="position: absolute; right: 1rem; top: 1rem;" onclick="window.print()">Cetak</button>
    ...
    <div>
        ...
        <p style="float: right">Kasir : {{ (auth()->user()->name) }}</p>
    </div>
    <div class="clear-both" style="clear: both;"></div>
    <p>No Trans : {{ nol_didepan($penjualan->id_penjualan, 8) }}</p>
    ...
    <script>
      ...
      let height = Math.max(
        ...
        html.clientHeigt, html.scrollHeight, html.offsetHeight
      );
      document.cookie = "Height=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
      document.cookie = "Height="+ ((height + 50) * 0.264583);
    </script>
</body>
</html>
